...
atlas-schaefer400parcel7networks_subcor32_1mm.nii: Schaefer 400-parcel and Tian 32-parcel atlas.
ic.nii: an independent component map derived from SBM analysis.
...
**Input Requirements**
data/ic.nii: NIfTI file containing the independent component map.
